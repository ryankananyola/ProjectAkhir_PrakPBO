...
public class EditByUser extends JFrame {
    ControllerAdmin controller;
    ModelUserByAdmin user;
    
    JLabel Header = new JLabel("EDIT DATA USER");
    JLabel labelEditID = new JLabel("ID");
    ...
    public EditByUser(ModelUserByAdmin user){
        this.user = user;
        ...
        tombolEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                controller.editUserByAdmin(user.getId());
            }
        });
    }
