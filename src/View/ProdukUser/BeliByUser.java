...
public class BeliByUser extends JFrame{
    ControllerProdukUser controller;

    JLabel Header = new JLabel("BELI PRODUK");
    ...
    JButton tombolTambah = new JButton("Beli");
        ...
        tombolTambah.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int response = JOptionPane.showConfirmDialog(
                    null,
                    "Pembelian tidak dapat dibatalkan, Yakin ingin membeli?",
